...
*/
  ...
  (function () {
    function B(a, b) {
      var c = a.getAscendant('table'),
        ...
        g = CKEDITOR.tools.buildTableMap(c),
        e = a.getAscendant('tr', !0).$.rowIndex,
        f = b.getAscendant('tr', !0).$.rowIndex,
        n = [],
        r = {},
        p,
        l;
      ...
      for (c = e; c <= f; c++)
        for (e = p; e <= l; e++)
          (d = new CKEDITOR.dom.element(g[c][e])),
            d.$ &&
    ...
    function L(a, b, c) {
      ...
      (g = h.active && !h.first) &&
        ...
        (g = 1 < d.length || (g[0] && !g[0].collapsed) ? !0 : !1));
      if (g) (h.first = b || d[0]), (h.dirty = b ? !1 : 1 !== d.length);
      else if (
        h.active &&
        b &&
        h.first.getAscendant('table').equals(b.getAscendant('table'))
      ) {
        d = B(h.first, b);
    ...
    function y(a) {
      function b(a, b) {
        return a && b
          ? a.equals(b) ||
              a.contains(b) ||
              b.contains(a) ||
              a.getCommonAncestor(b).is(p)
          : !1;
      }
      function c(a) {
        return (
          !a.getAscendant('table', !0) && a.getDocument().equals(g.document)
        );
      }
      function d(a, d, e, g) {
        return ('mousedown' === a.name && (D(a) || !g)) ||
          ('mouseup' === a.name && !c(a.data.getTarget()) && !b(e, g))
          ? !0
          : !1;
      }
      if (a.data.getTarget().getName) {
        var g = a.editor || a.listenerData.editor,
          ...
          f = J(g),
          n = a.data.getTarget(),
          r = n && n.getAscendant({ td: 1, th: 1 }, !0),
          n = n && n.getAscendant('table', !0),
          p = { table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1 };
        d(a, e, f, n) && C(g, !0);
        !h.active &&
          'mousedown' === a.name &&
          D(a) &&
          n &&
          ((h = { active: !0 }),
          CKEDITOR.document.on('mouseup', y, null, { editor: g }));
        (r || n) && L(g, r || n, a);
        'mouseup' === a.name &&
          (D(a) && (c(a.data.getTarget()) || b(f, n)) && K(g),
          (h = { active: !1 }),
    ...
    function O(a, b) {
      ...
      var d = a.getSelection(),
        ...
        p = a.blockless || CKEDITOR.env.ie ? 'span' : 'div',
        l,
        m,
        z,
        q;
      e.getById('cke_table_copybin') ||
        ((l = e.createElement(p)),
        (m = e.createElement(p)),
    ...
    function P(a) {
      ...
      var g = a.editor,
        e = g.dataProcessor,
        f = g.getSelection(),
        n = new CKEDITOR.dom.element('body'),
        r = 0,
        p = 0,
        l = 0,
        m = 0,
      ...
      if (
        ...
        if (1 < n.getChildCount() || !m)
          k[0].setHtml(n.getHtml()), g.fire('saveSnapshot');
        else {
          if (q) {
            k = l.getChildCount();
          ...
          if (f.length > q.length)
            for (r = f.length - q.length, e = 0; e < r; e++) H(k);
          ...
          r = E(k[0], !0);
          k = d(u);
          q = CKEDITOR.tools.buildTableMap(a, l.$.rowIndex, r, w.$.rowIndex, k);
          for (e = 0; e < f.length; e++)
            for (
              p = new CKEDITOR.dom.element(a.$.rows[l.$.rowIndex + e]), k = 0;
              k < f[e].length;
              k++
            )
              if (
                ((v = new CKEDITOR.dom.element(f[e][k])),
                (n =
                  q[e] && q[e][k] ? new CKEDITOR.dom.element(q[e][k]) : null),
                v && !v.getCustomData('processed'))
              ) {
                if (n && n.getParent()) v.replace(n);
                else if (0 === k || f[e][k - 1])
                  (n =
                    0 !== k ? new CKEDITOR.dom.element(f[e][k - 1]) : null) &&
                  p.equals(n.getParent())
                    ? v.insertAfter(n)
                    : 0 < r
                    ? v.insertAfter(new CKEDITOR.dom.element(p.$.cells[r]))
                    : p.append(v, !0);
          ...
          (function (a) {
              ...
              if (h && h.is && h.is(f)) {
                for (
                  var q = h.getAscendant('table', !0),
                    k = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q),
                    t = !1,
                    u = function (a) {
                  ...
                  k = k.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                !k &&
                  m &&
                  m.is &&
                  !m.is('table') &&
                  m.getNext() &&
                  ((k = m.getNext().findOne('td, th')), (t = !0));
                if (k) g['moveToElementEdit' + (t ? 'Start' : 'End')](k);
                else
                  g.setStartBefore(h.getAscendant('table', !0)), g.collapse(!0);
                l[0].deleteContents();
                return [g];
              }
            ...
            return function (f) {
              var h = f.data.getKey(),
                ...
                t,
                q;
              if (e[h] && (p = a.getSelection()) && p.isInTable() && p.isFake)
                if (
                  ((m = p.getRanges()),
        ...
        c.attachListener(
          ...
          function (d) {
            var c = a.getSelection(),
              e = d.data.$.charCode || 13 === d.data.getKey(),
              f;
            if (
              c &&
              c.isInTable() &&
  ...
  (function () {
    ...
    function h(a) {
      ...
      if (c) {
        ...
        'source' == b.mode &&
          (m
            ? 'mode' == a.name && c.setAttribute('placeholder', i)
            : l(c.getValue()) && (c.setValue(i), c.addClass('placeholder')));
      }
    }
    function n(a) {
      var a = a.editor,
      ...
      if (b) {
        ...
        'source' == a.mode &&
          b.hasClass('placeholder') &&
          (b.removeClass('placeholder'), b.setValue(''));
      }
    }
    function o(a) {
    ...
    CKEDITOR.plugins.add('confighelper', {
      ...
      init: function (a) {
        ...
        var b = a.element.getAttribute('placeholder') || a.config.placeholder;
        if (b) {
          ...
          a.on('getData', function (b) {
            var j = a.editable
              ...
              ? a.document && a.document.getBody()
              : a.textarea;
            j && j.hasClass('placeholder') && (b.data.dataValue = '');
          });
          a.on('setData', function (b) {
            if (!CKEDITOR.dialog._.currentTop && !('source' == a.mode && m)) {
              ...
              j &&
                (l(b.data.dataValue)
                  ? h(b)
                  : j.hasClass('placeholder') && j.removeClass('placeholder'));
            }
          });
          a.on('blur', h, null, b);
          a.on('mode', h, null, b);
        ...
        if (
          (b = a.config.contentsLanguage || o(a.element)) &&
        ...
        CKEDITOR.on('dialogDefinition', function (b) {
          if (a == b.editor) {
            ...
            !('removeDialogFields' in a._) &&
              a.config.removeDialogFields &&
              (a._.removeDialogFields = i(a.config.removeDialogFields));
            if (a._.removeDialogFields && (g = a._.removeDialogFields[c]))
              for (e in g) {
                f = g[e];
                k = b.getContents(e);
            ...
            !('hideDialogFields' in a._) &&
              a.config.hideDialogFields &&
              (a._.hideDialogFields = i(a.config.hideDialogFields));
            if (a._.hideDialogFields && (g = a._.hideDialogFields[c]))
              for (e in g) {
                f = g[e];
                k = b.getContents(e);
            ...
            if (
              a.config.dialogFieldsDefaultValues &&
              (g = a.config.dialogFieldsDefaultValues[c])
            )
              for (e in g) {
                f = g[e];
                k = b.getContents(e);
  ...
  CKEDITOR.lang.languages = { nl: 1, en: 1 };
})();
