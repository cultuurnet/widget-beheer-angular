    ...
    this.widgetEditForm = this.formBuilder.group({
      general: this.formBuilder.group({
        ...
        detail_link: this.formBuilder.group({
          enabled: [
            _.get(this.widget.settings, 'general.detail_link.enabled', ''),
          ],
      ...
      items: this.formBuilder.group({
        ...
        labels: this.formBuilder.group({
          ...
          limit_labels: this.formBuilder.group({
            enabled: [
              _.get(this.widget.settings, 'items.limit_labels.enabled', ''),
            ],
            labels: [
              _.get(this.widget.settings, 'items.limit_labels.labels', ''),
            ],
          }),
        }),
